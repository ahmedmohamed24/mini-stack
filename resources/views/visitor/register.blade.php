<div>
    ...
    <div class="flex justify-center my-2 mx-4 md:mx-0">
        <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6" wire:submit.lazy.prevent="submit">
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <input
                        ...
                        type='text' wire:model.lazy="name" value="{{ old('name') }}" id="name">
                    @include('inc.errors.name')
                </div>
                {{-- Email --}}
                <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <input
                        class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none"
                        type='email' wire:model.lazy="email" value="{{ old('email') }}" id="email">
                ...
                <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <input
                        class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none"
                        type='password' id="cpassword" wire:model.lazy="password_confirmation" value="{{ old('password_confirmation') }}">
                    @include('inc.errors.confirmPass')
                ...
                <div class="w-full md:w-full px-3 mb-6">
                    ...
                    <textarea
                        class="appearance-none block w-full bg-white text-gray-900 font-medium border border-gray-400 rounded-lg py-3 px-3 leading-tight focus:outline-none"
                        id="specialization" type="text" wire:model.lazy="specialization">{{ old('specialization') }}</textarea>
                    @include('inc.errors.specialization')
                </div>
                {{-- Image upload --}}
                @include('inc.upload')
